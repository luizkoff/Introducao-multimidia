...
class MonteCarlo:
    ...
    def loadMC(self): 
        ...
        arquivo.close()
        self.Q_A = config['Q_A'] # indica a porcentagem de cada movimento para cada estado
        self.S_A = config['S_A'] # indica quão bom é aquele estado ( grava um histórico do estado)
        self.POLITICA = config['POLITICA'] # indica de fato qual direção devemos seguir
